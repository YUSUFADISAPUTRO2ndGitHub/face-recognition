(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var DrawBox = /** @class */ (function () {
      ...
      DrawBox.prototype.draw = function (canvasArg, found_face_color) {
        console.log(canvasArg)
          var ctx = getContext2dOrThrow(canvasArg);
          var _a = this.options, boxColor = found_face_color, lineWidth = _a.lineWidth;
          var _b = this.box, x = _b.x, y = _b.y, width = _b.width, height = _b.height;
          ctx.strokeStyle = boxColor;
          ctx.lineWidth = lineWidth;
          ctx.strokeRect(x, y, width, height);
